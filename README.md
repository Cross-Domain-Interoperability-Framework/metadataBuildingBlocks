...
Profiles are organized into subdirectories: `_sources/profiles/adaProfiles/` (36 ADA profiles) and `_sources/profiles/cdifProfiles/` (5 CDIF profiles).
...
| profiles | `_sources/profiles/` | Composed profiles (ADA technique profiles, CDIF/DDE discovery profiles) |
