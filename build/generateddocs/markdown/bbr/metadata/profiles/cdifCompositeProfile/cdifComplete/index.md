...
`cdif.bbr.metadata.profiles.cdifCompositeProfile.cdifComplete` *v0.1*
...
- **Archive distribution** (`cdifManifest`) -- for archive files (ZIP, tar.gz) containing multiple component files described via `schema:hasPart`, each typed as `schema:MediaObject` with optional data description extensions
...
```json
{
  ...
  "schema:keywords": [
    {
      ...
      "schema:identifier": {
        ...
        "schema:propertyID": {
          "@id": "https://vocabularyserver.com/keyword"
        },
  ...
  "schema:distribution": [
    ...
    },
    {
      ...
      "cdi:isStructuredBy": {
        "@id": "ex:geochem-detailed-structure",
        "@type": [
    ...
    },
    {
      ...
      "schema:serviceType": {
        ...
        "schema:identifier": {
          ...
          "schema:propertyID": {
            "@id": "https://www.ogc.org/standards"
          },
  ...
  "schema:variableMeasured": [
    {
      ...
      "schema:propertyID": [
        {
          "@id": "urn:example:property:sampleID"
        }
      ],
      "cdif:physicalDataType": "string"
    },
    {
      ...
      "schema:propertyID": [
        {
          "@id": "urn:example:property:concentration"
        }
      ],
    ...
    },
    {
      ...
      "schema:propertyID": [
        {
          "@id": "urn:example:property:uncertainty"
        }
      ],
      "schema:unitText": "ppm",
      "schema:unitCode": "59",
    ...
    },
    {
      ...
      "schema:propertyID": [
        {
          "@id": "urn:example:property:wavelength"
        }
      ],
      "schema:unitText": "nm",
      "schema:minValue": 200,
    ...
    },
    {
      ...
      "schema:propertyID": [
        {
          "@id": "urn:example:property:intensity"
        }
      ],
...
```jsonld
{
  "@context": [
    ...
    "https://cross-domain-interoperability-framework.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/cdifCompositeProfile/cdifComplete/context.jsonld",
    {
      "schema": "http://schema.org/",
      "dcterms": "http://purl.org/dc/terms/",
      "geosparql": "http://www.opengis.net/ont/geosparql#",
...
ex:activity-geochem-analysis a schema1:Action,
    ...
    schema1:identifier [ a schema1:PropertyValue ;
            schema1:propertyID ex:activities ;
...
ex:complete-dataset-001 a schema1:Dataset ;
    ...
    schema1:relatedLink [ a schema1:LinkRole ;
            ...
            schema1:target [ a schema1:EntryPoint ;
                    ...
                    schema1:name "Regional geology map of the Great Basin" ;
                    schema1:url "https://example.org/maps/great-basin-geology" ] ] ;
    ...
    schema1:spatialCoverage [ a schema1:Place ;
            schema1:alternateName "Great Basin" ;
...
- type: object
  description: cdifComplete-specific additions. Measurement technique, spatial / temporal
    coverage, and quality measurement come through from cdifDiscovery via the allOf
    composition above; this branch only adds the multi-spec conformance declarations
    that mark a record as cdifComplete.
  properties:
    '@context':
      type: object
      ...
      properties:
        dcterms:conformsTo:
          ...
          - contains:
              ...
              properties:
                '@id':
                  const: https://w3id.org/cdif/provenance/1.1
...
* YAML version: [schema.yaml](https://cross-domain-interoperability-framework.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/cdifCompositeProfile/cdifComplete/schema.json)
* JSON version: [schema.json](https://cross-domain-interoperability-framework.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/cdifCompositeProfile/cdifComplete/schema.yaml)
...
[context.jsonld](https://cross-domain-interoperability-framework.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/cdifCompositeProfile/cdifComplete/context.jsonld)
...
* Path: `_sources/profiles/cdifCompositeProfile/cdifComplete`
