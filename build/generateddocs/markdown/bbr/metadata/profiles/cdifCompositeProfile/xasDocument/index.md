            ...
            cdi:isStructuredBy [ a cdi:WideDataStructure ;
                    ...
                    cdi:has_DataStructureComponent [ a cdi:IdentifierComponent ;
                            cdi:has [ a cdi:ValueMapping ;
                                    cdi:hasIndex 1 ;
                                    cdi:length 12 ] ;
                            cdif:isDefinedBy_Variable <file:///github/workspace/#rv-energy> ],
                        [ a cdi:MeasureComponent ;
                            cdi:has [ a cdi:ValueMapping ;
                                    cdi:hasIndex 2 ;
                                    cdi:length 12 ] ;
                            cdif:isDefinedBy_Variable <file:///github/workspace/#itrans> ],
                        [ a cdi:MeasureComponent ;
                            cdi:has [ a cdi:ValueMapping ;
                                    cdi:hasIndex 3 ;
                                    cdi:length 13 ] ;
                            cdif:isDefinedBy_Variable <file:///github/workspace/#i0> ] ;
                    cdi:headerRowCount 27 ;
                    cdi:isDelimited false ;
                    cdi:isFixedWidth true ;
                    cdi:skipInitialSpace true ] ;
...
<file:///github/workspace/#energy> a cdi:InstanceVariable,
    ...
    cdif:name "energy" ;
    cdif:physicalDataType "https://www.w3.org/TR/xmlschema-2/#decimal" ;
    cdif:uses <file:///github/workspace/#rv-energy> .
...
xas:487y54123 a schema1:Dataset,
    ...
    schema1:distribution [ a cdi:TabularTextDataSet,
                schema1:DataDownload ;
            cdi:isFixedWidth true ;
            cdi:isStructuredBy xas:xdiWideStructure ;
            dcterms:conformsTo <https://github.com/XraySpectroscopy/XAS-Data-Interchange/blob/master/specification/spec.md> ;
            schema1:contentUrl "https://github.com/XraySpectroscopy/XASDataLibrary/blob/master/data/Se/Se_Na2SeO4_rt_01.xdi" ;
...
xas:xdiWideStructure a cdi:WideDataStructure ;
    cdi:has_DataStructureComponent [ a cdi:IdentifierComponent ;
            cdif:isDefinedBy_Variable xas:monochromatorenergy ],
        [ a cdi:MeasureComponent ;
            cdif:isDefinedBy_Variable xas:incidentintensity ],
        [ a cdi:MeasureComponent ;
            cdif:isDefinedBy_Variable xas:transmittedintensity ] .
...
<https://example.org/struct/DV/BYSPHH/comp/Column_1> a cdi:MeasureComponent ;
    cdif:isDefinedBy_Variable <https://example.org/struct/DV/BYSPHH/rv/Column_1> .

<https://example.org/struct/DV/BYSPHH/comp/Column_2> a cdi:MeasureComponent ;
    cdif:isDefinedBy_Variable <https://example.org/struct/DV/BYSPHH/rv/Column_2> .

<https://example.org/struct/DV/BYSPHH/comp/Column_3> a cdi:MeasureComponent ;
    cdif:isDefinedBy_Variable <https://example.org/struct/DV/BYSPHH/rv/Column_3> .

<https://example.org/struct/DV/BYSPHH/comp/Column_4> a cdi:MeasureComponent ;
    cdif:isDefinedBy_Variable <https://example.org/struct/DV/BYSPHH/rv/Column_4> .

<https://example.org/struct/DV/BYSPHH/rv/Column_1> a cdi:RepresentedVariable ;
    cdif:name "energy" .

<https://example.org/struct/DV/BYSPHH/rv/Column_2> a cdi:RepresentedVariable ;
    cdif:name "time" .

<https://example.org/struct/DV/BYSPHH/rv/Column_3> a cdi:RepresentedVariable ;
    cdif:name "i0" .

<https://example.org/struct/DV/BYSPHH/rv/Column_4> a cdi:RepresentedVariable ;
    cdif:name "itrans" .
