...
`cdif.bbr.metadata.profiles.cdifProfile.cdifProvenance` *v0.1*
...
{
  "@context": [
    "https://cross-domain-interoperability-framework.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/cdifProfile/cdifProvenance/context.jsonld",
    {
      "schema": "http://schema.org/",
      "prov": "http://www.w3.org/ns/prov#",
      "dcterms": "http://purl.org/dc/terms/",
...
ex:metadata_provenance_001 a schema1:Dataset ;
    dcterms:conformsTo <https://w3id.org/cdif/provenance/1.1> ;
...
<file:///github/workspace/#KI81-1-olivine> a schema1:Thing,
        prov:Entity ;
    schema1:description "Hand-picked olivine grains (Fo85-88) from Kilauea Iki lava lake drill core." ;
...
* YAML version: [schema.yaml](https://cross-domain-interoperability-framework.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/cdifProfile/cdifProvenance/schema.json)
* JSON version: [schema.json](https://cross-domain-interoperability-framework.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/cdifProfile/cdifProvenance/schema.yaml)
...
[context.jsonld](https://cross-domain-interoperability-framework.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/cdifProfile/cdifProvenance/context.jsonld)
...
* Path: `_sources/profiles/cdifProfile/cdifProvenance`
