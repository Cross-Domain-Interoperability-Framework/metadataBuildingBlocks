...
# DDI-CDI Key Value Structure (Schema)

`cdif.bbr.metadata.ddiProperties.ddicdiKeyValueStructure` *v0.1*
...
### Key-value datastore structure
A cdi:KeyValueStructure with two data-structure components, a primary-key
reference, and an isDefinedBy link to the RepresentedVariable it describes
(component, key, and variable referenced by @id).
#### json
```json
{
  "@context": {
...
```jsonld
{
  "@context": [
    ...
    "https://cross-domain-interoperability-framework.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/ddiProperties/ddicdiKeyValueStructure/context.jsonld",
    {
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
      "ex": "https://example.org/"
    }
...
<https://example.org/kvstructure/observations> a cdi:KeyValueStructure ;
    cdi:has_DataStructureComponent <https://example.org/component/measuredValue>,
        <https://example.org/component/stationId> ;
    cdi:has_PrimaryKey <https://example.org/key/observationPK> ;
    cdi:identifier [ a cdi:Identifier ;
            cdi:uri "https://example.org/kvstructure/observations" ] ;
    cdi:isDefinedBy <https://example.org/representedVariable/observation> .
...
title: DDI-CDI Key Value Structure
...
- $ref: '#/$defs/KeyValueDataStore'
- $ref: '#/$defs/InstanceKey'
- $ref: '#/$defs/MainKeyMember'
- $ref: '#/$defs/ContextualComponent'
- $ref: '#/$defs/SyntheticIdComponent'
$defs:
  KeyValueStructure:
    type: object
    description: Structure of a key-value datastore (organized collection of key-value
  ...
  KeyValueDataStore:
    type: object
    description: Organized collection of key-value data. It is structured by a key
      value structure.
    properties:
      '@type':
        type: array
        items:
          type: string
        contains:
          const: cdi:KeyValueDataStore
        minItems: 1
      '@id':
        type: string
        description: Identifier for this KeyValueDataStore node
      cdi:identifier:
        $ref: https://cross-domain-interoperability-framework.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/ddiProperties/ddicdiDataTypes/schema.yaml#/$defs/Identifier
        description: Identifier for objects requiring short- or long-lasting referencing
          and management.
  ...
  InstanceKey:
    type: object
    description: Single-valued key representation produced from the merge of the representations
      of all key members and a descriptor.
    properties:
      '@type':
        type: array
        items:
          type: string
        contains:
          const: cdi:InstanceKey
        minItems: 1
      '@id':
        type: string
        description: Identifier for this InstanceKey node
      cdi:has:
        anyOf:
  ...
  MainKeyMember:
    type: object
    description: Identifies the unit of interest, either a statistical unit or a population,
      via identifier or dimension components, respectively, plus an optional contextual
      component. If neither identifier nor dimension components are present, then
      a synthetic id component is used.
    properties:
      '@type':
        type: array
        items:
          type: string
        contains:
          const: cdi:MainKeyMember
        minItems: 1
      '@id':
        type: string
        description: Identifier for this MainKeyMember node
      cdi:hasValueFrom:
        anyOf:
  ...
  ContextualComponent:
    type: object
    description: Encapsulates contextual information of the key-value datastore to
      provide a scope to the instance key. The instance key is unique within the scope.
    properties:
      '@type':
        type: array
        items:
          type: string
        contains:
          const: cdi:ContextualComponent
        minItems: 1
      '@id':
        type: string
        description: Identifier for this ContextualComponent node
      cdi:identifier:
        $ref: https://cross-domain-interoperability-framework.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/ddiProperties/ddicdiDataTypes/schema.yaml#/$defs/Identifier
        description: Identifier for objects requiring short- or long-lasting referencing
          and management.
  ...
  SyntheticIdComponent:
    type: object
    description: Persistent and unique identifier (PIDs) to provide standarized, long-lasting
      identification.
    properties:
      '@type':
        type: array
        items:
          type: string
        contains:
          const: cdi:SyntheticIdComponent
        minItems: 1
      '@id':
        type: string
        description: Identifier for this SyntheticIdComponent node
      cdi:identifier:
        $ref: https://cross-domain-interoperability-framework.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/ddiProperties/ddicdiDataTypes/schema.yaml#/$defs/Identifier
        description: Identifier for objects requiring short- or long-lasting referencing
          and management.
...
* YAML version: [schema.yaml](https://cross-domain-interoperability-framework.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/ddiProperties/ddicdiKeyValueStructure/schema.json)
* JSON version: [schema.json](https://cross-domain-interoperability-framework.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/ddiProperties/ddicdiKeyValueStructure/schema.yaml)
...
[context.jsonld](https://cross-domain-interoperability-framework.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/ddiProperties/ddicdiKeyValueStructure/context.jsonld)
...
* Path: `_sources/ddiProperties/ddicdiKeyValueStructure`
