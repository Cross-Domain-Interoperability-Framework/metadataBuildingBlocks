...
# DDI-CDI Instance Variable (Schema)

`cdif.bbr.metadata.ddiProperties.ddicdiInstanceVariable` *v0.1*
...
title: DDI-CDI Instance Variable
description: Use of a represented variable within a data set.
type: object
properties:
  '@type':
    type: array
  ...
  cdi:has_PhysicalSegmentLayout:
    ...
    items:
      anyOf:
      - $ref: https://cross-domain-interoperability-framework.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/ddiProperties/ddicdiPhysicalSegmentLayout/schema.yaml
...
* YAML version: [schema.yaml](https://cross-domain-interoperability-framework.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/ddiProperties/ddicdiInstanceVariable/schema.json)
* JSON version: [schema.json](https://cross-domain-interoperability-framework.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/ddiProperties/ddicdiInstanceVariable/schema.yaml)
...
[context.jsonld](https://cross-domain-interoperability-framework.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/ddiProperties/ddicdiInstanceVariable/context.jsonld)
...
* Path: `_sources/ddiProperties/ddicdiInstanceVariable`
