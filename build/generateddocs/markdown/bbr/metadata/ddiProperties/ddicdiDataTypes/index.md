...
$defs:
  ...
  CorrespondenceDefinition:
    ...
    description: DDI-CDI CorrespondenceDefinition (dt-CorrespondenceDefinition). Describes
      the commonalities and differences between two members using textual descriptions
      plus an optional coding of the type of match.
    properties:
      '@type':
        type: array
        items:
  ...
  StructureSpecification:
    ...
    description: "DDI-CDI StructureSpecification (dt-StructureSpecification). The
      mathematical properties of a structure \u2014 whether the member relationship
      is reflexive, symmetric, and/or transitive over the members in scope."
    properties:
      '@type':
        type: array
        items:
          type: string
        contains:
          const: cdi:StructureSpecification
        minItems: 1
      cdi:reflexive:
        type: string
        enum:
