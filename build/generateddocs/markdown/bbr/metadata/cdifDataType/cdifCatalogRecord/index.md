...
`cdif.bbr.metadata.cdifDataType.cdifCatalogRecord` *v0.2*
...
```jsonld
{
  "@context": [
    ...
    "https://cross-domain-interoperability-framework.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/cdifDataType/cdifCatalogRecord/context.jsonld",
    {
      "schema": "http://schema.org/",
      "dcat": "http://www.w3.org/ns/dcat#",
      "dcterms": "http://purl.org/dc/terms/",
...
properties:
  ...
  schema:includedInDataCatalog:
    ...
    x-jsonld-id: http://schema.org/includedInDataCatalog
required:
- schema:about
- dcterms:conformsTo
- schema:additionalType
...
* YAML version: [schema.yaml](https://cross-domain-interoperability-framework.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/cdifDataType/cdifCatalogRecord/schema.json)
* JSON version: [schema.json](https://cross-domain-interoperability-framework.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/cdifDataType/cdifCatalogRecord/schema.yaml)
...
[context.jsonld](https://cross-domain-interoperability-framework.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/cdifDataType/cdifCatalogRecord/context.jsonld)
...
* Path: `_sources/cdifDataType/cdifCatalogRecord`
