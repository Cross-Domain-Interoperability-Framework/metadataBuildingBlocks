...
`cdif.bbr.metadata.cdifDataType.cdifOpenApi` *v0.1*
...
```jsonld
{
  "@context": [
    ...
    "https://cross-domain-interoperability-framework.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/cdifDataType/cdifOpenApi/context.jsonld",
    {
      "schema": "http://schema.org/",
      "oas": "https://spec.openapis.org/oas/3.1#",
      "ex": "https://example.org/"
...
$defs:
  ...
  Schema:
    ...
    properties:
      ...
      oas:$ref:
        ../../cdifDataType/cdifOpenApi/type: string
        format: uri
...
* YAML version: [schema.yaml](https://cross-domain-interoperability-framework.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/cdifDataType/cdifOpenApi/schema.json)
* JSON version: [schema.json](https://cross-domain-interoperability-framework.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/cdifDataType/cdifOpenApi/schema.yaml)
...
[context.jsonld](https://cross-domain-interoperability-framework.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/cdifDataType/cdifOpenApi/context.jsonld)
...
* Path: `_sources/cdifDataType/cdifOpenApi`
