...
properties:
  ...
  cdif:isDefinedBy_RepresentedVariable:
    ...
    description: 'The RepresentedVariable this InstanceVariable instantiates. A reference
      ...
      so an inline copy would defeat it. The equivalent link within a data structure
      is cdif:isDefinedBy_Variable on cdifDataStructureComponent -- a different name
      because it means something wider: it accepts an InstanceVariable as well (in
      DDI-CDI an InstanceVariable IS a RepresentedVariable), and accepts one inline,
