...
$defs:
  ...
  SentinelValueDomain:
    type: object
    description: Specification of possible sentinel values used by a variable. Sentinel
      values are special values used to indicate various invalid conditions for a
      variable, e.g. below detection, missing value.
    properties:
      '@type':
        type: array
        items:
