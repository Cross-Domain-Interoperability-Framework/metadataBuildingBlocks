...
$defs:
  ...
  DimensionalDataStructure:
    ...
    properties:
      ...
      cdi:has_DataStructureComponent:
        ...
        items:
          anyOf:
          - $ref: https://cross-domain-interoperability-framework.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/cdifProperties/cdifDataStructureComponent/schema.yaml#/$defs/UnitIdentifierComponent
  ...
  LongDataStructure:
    ...
    properties:
      ...
      cdi:has_DataStructureComponent:
        type: array
        description: A LongDataStructure must include exactly one UnitIdentifierComponent,
