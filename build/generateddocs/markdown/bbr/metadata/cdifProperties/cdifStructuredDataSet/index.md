...
`cdif.bbr.metadata.cdifProperties.cdifStructuredDataSet` *v0.1*
...
properties:
  cdif:encoding:
    ...
    x-jsonld-id: https://cdif.org/0.1/encoding
x-jsonld-prefixes:
...
* YAML version: [schema.yaml](https://cross-domain-interoperability-framework.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/cdifProperties/cdifStructuredDataSet/schema.json)
* JSON version: [schema.json](https://cross-domain-interoperability-framework.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/cdifProperties/cdifStructuredDataSet/schema.yaml)
...
[context.jsonld](https://cross-domain-interoperability-framework.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/cdifProperties/cdifStructuredDataSet/context.jsonld)
...
* Path: `_sources/cdifProperties/cdifStructuredDataSet`
