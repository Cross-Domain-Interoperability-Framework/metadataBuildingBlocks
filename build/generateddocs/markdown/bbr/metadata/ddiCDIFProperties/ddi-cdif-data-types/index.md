...
`cdif.bbr.metadata.ddiCDIFProperties.ddi-cdif-data-types` *v0.1*
...
$defs:
  ...
  ControlledVocabularyEntry:
    ...
    description: DDI-CDI controlled vocabulary entry (dt-ControlledVocabularyEntry).
      Allows for unstructured content which may be an entry from an externally maintained
      controlled vocabulary. When the content is from a controlled vocabulary, provide
      the code value of the entry along with a reference to the vocabulary from which
      the value is taken.
    properties:
      '@type':
        type: array
        ...
        minItems: 1
      cdi:entryReference:
        description: A reference to the specific item in the vocabulary referenced
          by cdi:vocabulary, using a URI or other resolvable identifier.
        type: array
        items:
          $ref: '#/$defs/Reference'
        minItems: 1
  ...
  PairedControlledVocabularyEntry:
    ...
    description: DDI-CDI tightly-bound pair of controlled vocabulary entries (dt-PairedControlledVocabularyEntry).
      The extent property describes the extent to which the parent term applies for
      the specific case.
    properties:
      '@type':
        type: array
        items:
          type: string
        contains:
          const: cdi:PairedControlledVocabularyEntry
        minItems: 1
      cdi:term:
...
* YAML version: [schema.yaml](https://cross-domain-interoperability-framework.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/ddiCDIFProperties/ddi-cdif-data-types/schema.json)
* JSON version: [schema.json](https://cross-domain-interoperability-framework.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/ddiCDIFProperties/ddi-cdif-data-types/schema.yaml)
...
[context.jsonld](https://cross-domain-interoperability-framework.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/ddiCDIFProperties/ddi-cdif-data-types/context.jsonld)
...
* Path: `_sources/ddiCDIFProperties/ddi-cdif-data-types`
