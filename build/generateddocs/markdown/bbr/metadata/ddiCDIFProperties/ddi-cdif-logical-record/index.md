...
# DDI-CDI Logical Record (Schema)

`cdif.bbr.metadata.ddiCDIFProperties.ddi-cdif-logical-record` *v0.1*
...
title: DDI-CDI Logical Record
description: Collection of instance variables.
type: object
properties:
  '@type':
    type: array
  ...
  cdi:organizes:
    ...
    minItems: 1
    x-jsonld-id: http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/organizes
  cdi:isDefinedBy:
    type: array
...
* YAML version: [schema.yaml](https://cross-domain-interoperability-framework.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/ddiCDIFProperties/ddi-cdif-logical-record/schema.json)
* JSON version: [schema.json](https://cross-domain-interoperability-framework.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/ddiCDIFProperties/ddi-cdif-logical-record/schema.yaml)
...
[context.jsonld](https://cross-domain-interoperability-framework.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/ddiCDIFProperties/ddi-cdif-logical-record/context.jsonld)
...
* Path: `_sources/ddiCDIFProperties/ddi-cdif-logical-record`
