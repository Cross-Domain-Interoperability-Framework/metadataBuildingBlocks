...
### `cdif.bbr.metadata.profiles.cdifProfile.cdifArchiveDistribution` — CDIF Archive Distribution
...
### `cdif.bbr.metadata.profiles.cdifCompositeProfile.BasicDiscovery` — CDIF discovery metadata
...
### `cdif.bbr.metadata.profiles.cdifCompositeProfile.BasicDataDescription` — CDIF discovery and data description metadata
...
### `cdif.bbr.metadata.profiles.cdifCompositeProfile.DataDescriptionWithStructure` — CDIF Data Structure profile
