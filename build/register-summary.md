...
### `cdif.bbr.metadata.cdifProperties.cdifCodelist` — CDIF Codelist
...
### `cdif.bbr.metadata.cdifProperties.cdifTabularTextDataSet` — CDIF TabularTextDataSet building block
...
### `cdif.bbr.metadata.cdifProperties.cdifTextMapping` — CDIF TextMapping building block
